        ...
        <div class="tool-section">
          ...
          <el-card>
            ...
            <div class="tool-flex-row">
              <el-input v-model="jwtSecretInput" placeholder="密钥（可选），例如：your-secret-key" class="tool-flex-item" />

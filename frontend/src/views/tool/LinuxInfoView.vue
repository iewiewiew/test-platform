<template>
  <div class="common-list-container">
    ...
    <el-table :data="paginatedServers" style="width: 100%" height="900px" v-loading="loading" :row-class-name="getRowClassName">
        ...
        <template #default="scope">
          <el-popover placement="right" :width="320" trigger="hover" :show-after="300" popper-class="server-info-popover">
            ...
            <div class="server-info-popover-content">
              ...
              <div class="server-info-divider"></div>
...
const filteredServers = computed(() => {
  ...
  if (searchForm.value.server_name) {
    filtered = filtered.filter((server) => server.server_name.toLowerCase().includes(searchForm.value.server_name.toLowerCase()))
  }

  if (searchForm.value.host) {
    filtered = filtered.filter((server) => server.host.toLowerCase().includes(searchForm.value.host.toLowerCase()))
  }

    ...
    <div class="main-container">
      ...
      <div class="top-navbar">
        ...
        <div class="navbar-right">
          ...
          <!-- GitHub 源码链接 -->
          <a href="https://github.com/iewiewiew/test-platform" target="_blank" rel="noopener noreferrer" class="github-link">
            源码
          </a>
...
import { Document, DataBoard, Menu as IconMenu, FolderOpened, Setting, Connection, Tools, Monitor, SetUp, User, ArrowDown, SwitchButton, Close, MoreFilled, Moon, Sunny } from '@element-plus/icons-vue'
